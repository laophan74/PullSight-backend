...
public sealed class RuleBasedCodeReviewAnalyzer(ReviewSummaryService summaryService) : ICodeReviewAnalyzer
{
    public RuleBasedCodeReviewAnalyzer()
        : this(new ReviewSummaryService())
    {
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var legacySummary = findings.Count == 0
        ...
        var summary = summaryService.BuildFallback(legacySummary, pullRequestDiff, findings);
    ...
    public Task<ReviewRunResponse> AnalyzeDemoAsync(CancellationToken cancellationToken)
    {
        ...
        var summary = summaryService.BuildFallback(
